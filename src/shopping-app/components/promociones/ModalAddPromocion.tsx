                                    ...
                                    <Form className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="flex items-center mb-4">
                                                <input disabled={showCategorias}  checked={showProducts} onChange={ onShowProductsClick } id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                                <label className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> productos</label>

                                                <input disabled={showProducts} checked={showCategorias}  onChange={ onShowCategoriasClick } id="default-checkbox" type="checkbox" value="" className="w-4 h-4 ml-2 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            <div className="flex items-center mb-4">
                                                    <input  onChange={ onShowDescuentoClick } checked={showDescuento} id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
