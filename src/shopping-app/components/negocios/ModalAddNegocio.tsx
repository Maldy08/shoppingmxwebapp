                                            ...
                                            <div className="">
                                                ...
                                                <div className="mt-2">
                                                    <Field
                                                        name="nombre_empresa"
                                                        type="text"
                                                        className="block w-full rounded-md border-0 py-1.5 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-2">
                                                    <Field
                                                        ...
                                                        type="number"
                                                        className=" w-full rounded-md border-0 py-1.5 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            ...
                                            <div className="mt-2">
                                                {
                                                    ...
                                                    className="block w-full cursor-pointer p-2 rounded-md border-0 py-1.5 bg-gray-100 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
